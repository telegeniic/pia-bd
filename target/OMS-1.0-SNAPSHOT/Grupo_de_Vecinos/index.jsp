...
<head>
    ...
    <title>Rey Mago - Grupo Vecinos</title>
</head>
<body>
...
<h1 class="text-center font-weight-bold">Grupos de Vecinos</h1>
...
<table class="table table-striped table-hover text-center">
    ...
    <tbody>
        <c:forEach var="obj" items="${lista}">
            <tr>
                <td>
                    <c:out value="${obj.getClave_Grupo_de_Vecinos()}"></c:out>
                </td>
                <td>
                    <c:out value="${obj.getColonia_Grupo_de_Vecinos()}"></c:out>
                </td>
                <td>
