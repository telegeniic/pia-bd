...
<h1 class="text-center font-weight-bold">Vecinos</h1>
    ...
    <tbody>
        <c:forEach var="obj" items="${lista}">
            <tr>
                ...
                <td>
                    <c:out value="${obj.getApellido_Paterno()}"></c:out>
                </td>
                <td>
                    <c:out value="${obj.getApellido_Materno()}"></c:out>
                </td>
                <td>
                    <c:out value="${obj.getNombre_Vecinos()}"></c:out>
                </td>
