...
<head>
    ...
    <title>Rey Mago - Convencidos</title>
</head>
<body>
...
<h1 class="text-center font-weight-bold">Convencidos</h1>

<table class="table table-striped table-hover text-center">
    <thead>
    <tr>
        <th>DNI Convencedor</th>
        <th>DNI Convencido</th>
        <th></th>
        <th></th>
    </tr>
    </thead>
    <tbody>
        <c:forEach var="obj" items="${lista}">
            <tr>
                <td>
                    <a style="text-decoration: none" href="VecinosController">
                    <c:out value="${obj.getDNI_Convencedor()}"></c:out>
                    </a>
                </td>
                <td>
                    <a style="text-decoration: none" href="VecinosController">
                    <c:out value="${obj.getDNI_Convencido()}"></c:out>
                    </a>
                </td>
